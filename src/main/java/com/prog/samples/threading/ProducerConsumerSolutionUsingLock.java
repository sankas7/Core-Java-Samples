...
class ProducerConsumerImpl {
    ...
    public void put() throws InterruptedException {
        aLock.lock();
        System.out.println("Accured Put Producer lock");
        try {
        	...
        	System.out.println("Leaving lock Producer");
            aLock.unlock();
        }
    }
    ...
    public void get() throws InterruptedException {
        aLock.lock();
        System.out.println("Accured Get Consumer lock");
        try {
            while (queue.size() == 0) {
                System.out.println(Thread.currentThread().getName()
        	...
        	System.out.println("Leaving lock Consumer");
            aLock.unlock();
        }
    }
}
